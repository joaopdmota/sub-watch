...
type ConfigMap struct {
	...
	ServiceName             string
	OtelEnabled             bool
	CnpjFinderClientUrl     string
	CnpjFinderClientTimeout int
}
...
func LoadEnvs() *ConfigMap {
	...
	Config = &ConfigMap{
		...
		CnpjFinderClientUrl:     GetEnvString("CNPJ_FINDER_URL"),
		CnpjFinderClientTimeout: GetEnvNumber("CNPJ_FINDER_TIMEOUT"),
	}
