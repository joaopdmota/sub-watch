...
```env
API_PORT=8080
SERVICE_NAME=sub-watch-microservice

# Observabilidade (opcional)
OTEL_ENABLED=false
OTEL_EXPORTER_OTLP_ENDPOINT=http://otel-collector:4317
OTEL_SERVICE_NAME=sub-watch-microservice
...
| `SERVICE_NAME`                | Nome lógico do serviço                             | `sub-watch-microservice`                            |
...
| `OTEL_SERVICE_NAME`           | Nome do serviço nos traces                         | `sub-watch-microservice`                            |
